...
def _setup_parser():
    ...
    parser.add_argument("--contextualization",type=bool,default=False)
...
def main():
    ...
    model_checkpoint = pl.callbacks.ModelCheckpoint(monitor=metric_name, mode="max",
        ...
        dirpath=os.path.join("output", '{}_{}'.format(args.dataset, str(args.contextualization))),
    ...
    # exit()
    # if args.checkpoint:
    #     # print(torch.load(args.checkpoint, map_location="cpu")['module'].keys())
    #     # exit()
    #     lit_model.model.load_state_dict(torch.load(args.checkpoint, map_location="cpu")['module'])
    #     trainer.test(lit_model, datamodule=data)
    #     return

    # lit_model = litmodel_class.load_from_checkpoint('/home/dawei/projects/dawei/PromptKG/lambdaKG/output/FB15k-237N_True__origin/epoch=9-acc1=0.00.ckpt/checkpoint/mp_rank_00_model_states.pt')
